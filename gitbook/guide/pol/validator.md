...
>   * timestamp를 eip-4788의 [history\_buf\_length](../../undefined.md#id-1-history_buf_length-eip-4788-8191-12-2)로 mod 연산을 하여 `_processedTimestampsBuffer`에 삽입
>   * EIP-4788의 ring buffer 메커니즘에 따라 8191 슬롯([약 4.55시간, 2초 간격 기준](../../undefined.md#id-3-4.55-8191-2-8)) 후 덮어씌워짐, 이는 보상 주기와 일치함&#x20;
> *   **Beacon block root과 proposer index/pubkey 의 암호학적 검증**
>
>     * &#x20;[`SSZ.verifyProof`](../../undefined.md#id-2-ssz.verifyproof-simple-serialize-merkle-proposer-index) 함수를 사용하여, 특정 타임스탬프의 비콘 루트를 기준으로 해당 제안자의 보상 자격을 검증
>     * 검증 실패시 revert 발생
>
>     ```solidity
...
> * **운영자 변경 시**[ **queue 메커니즘과 시간 지연**](../../undefined.md#id-4-beacondeposit-24)**을 통한 급작스러운 변경 방지**
...
> * **운영자 변경 시 기존 예치 잔액에 대한** [**잠금 기간 설정 및 점진적 권한**](../../undefined.md#id-5-greater-than-20) **이전**
