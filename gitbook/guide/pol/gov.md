...
>   * 제곱근 기반 [**Quadratic Voting**](../../undefined.md#quadratic-voting-bgt-15) 방식 적용하여 대량 보유자의 영향력 축소
...
>   * 생태계 참여자들의 의견을 수렴할 수 있는 [**최소한의 기한(2\~3주, DeFi 평균 피드백 소요 시간 기준)**](../../undefined.md#defi-2-3-uniswap-rfc-7-14-.-compound-6.95-.-2-3)를 거쳐 정식 토큰 및 금고로 등록
> * **통과된 제안은 가디언즈의 검증을 거칠** [**타임락 기간**](../../undefined.md#berachain-2-guardian-5-of-9-multisig-2) **필요**
...
>   * **이의제기 메커니즘:** [**독립적인 중재 위원회**](../../undefined.md#id-30)(리뷰어 선출 과정과 동일)를 구성하여 다음 권한 부여
...
프로토콜 역시 온체인 거버넌스를 구현할 계획을 가지고 있지만 현재 [**구현이 안된 상태**](../../undefined.md#id-5-100-bgt)이기에 `Informational` 평가
...
> * **거버넌스 제안 통과 후 실제 적용까지** [**최소 14일의 공지 기간**](../../undefined.md#defi-14-14-30)**을 두고** \
