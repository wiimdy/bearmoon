...
> * **최초 유동성이 없는 상태에서 극소량의 예치금을 통한 교환 비율 왜곡 현상을 방지하기 위해 컨트랙트 배포 단계에서 최소 지분을 예치하여 zero totalsupply, zero division 현상 방지**
...
> * **검증자의 장기간 비정상 행위로 인한 네트워크 안정성 저해를 방지하기 위해 실시간 상태 추적과 자동 강제 종료 시스템 도입 필요**
