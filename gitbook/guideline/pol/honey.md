...
> * **Basket 모드가 활성화 된 상태에서 상환 시 디페깅된 자산은** [**3개 이상의 오라클**](../../reference.md#chainlink)**을 참조하여 자산의 가치를 평가(현재 베라체인은 신뢰가능한 chainlink 오라클 및 HONEY 오라클로 pyth, spot 오라클 참조하고 있음)**
