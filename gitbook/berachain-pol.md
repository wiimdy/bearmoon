...
**PoL(Proof of Liquidity)**&#xC740; 기존 PoS(Proof of Stake)과 달리 **생태계에 실질적 유동성을 공급**하는 베라체인의 새로운 메커니즘 입니다.

기존 방식처럼 단순히 토큰을 스테이킹하는 것이 아니라, 사용자가 먼저 DEX, 대출 프로토콜 등 베라체인에 직접 유동성을 공급하고, 그 대가로 얻은 BGT를 스테이킹하여 네트워크에 기여하는,보다 적극적이고 생태계 친화적인 참여 방식을 제시합니다.
