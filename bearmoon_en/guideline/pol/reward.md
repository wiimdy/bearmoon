...
> * **Use** [**ReentrantGuard**](../../reference.md#oz-reentrancyguard-spec)<sub>**7**</sub>
...
> * [**Limit incentive token count and prevent duplicate registration when managing the incentive token whitelist**](../../reference.md#berachain-rewardvault-whitelist)<sub>**8**</sub>
